    ...
    return (
      <div className="container mx-auto p-4 md:p-8 flex flex-col items-center justify-center h-[calc(100vh-10rem)]">
        <Card className="text-center p-8">
            <CardTitle className="text-2xl">No Teams to Export</CardTitle>
            <CardContent className="mt-4">
                <p className="text-muted-foreground">You haven't formed any teams yet.</p>
                <Link href="/form-teams">
                    <Button className="mt-4">Go to Form Teams</Button>
                </Link>
            </CardContent>
        </Card>
      </div>
  ...
  return (
    <div className="container mx-auto p-4 md:p-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold">Final Team Compositions</h1>
        <p className="text-muted-foreground">Review your teams and export them as images.</p>
      </div>
